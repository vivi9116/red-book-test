...
const pages = [
  {
    ...
    title: ["你对TA", "是生理性喜欢", "还是心理性喜欢？"],
    badge: "10题测一测",
    footer: "每题选最像你的答案，算好总分。",
  },
  {
    file: "02-q1-3.png",
    raw: ".raw-02-q1-3.png",
...
function overlaySvg(page) {
  const body = Array.isArray(page.footer) ? resultOverlay(page) : page.title instanceof Array ? coverOverlay(page) : questionsOverlay(page);
